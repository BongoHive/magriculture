...
urlpatterns = patterns('',
    ...
    url(r'^farmers/(?P<farmer_pk>\d+)/location/delete/$', views.farmer_location_delete, name='farmer_location_delete'),
    url(r'^farmers/(?P<farmer_pk>\d+)/location/(?P<district_pk>\d+)/delete/confirm$', views.farmer_location_delete_confirm, name='farmer_location_delete_confirm'),
