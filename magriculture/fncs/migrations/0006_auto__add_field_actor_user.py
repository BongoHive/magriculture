...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Actor.user'
        db.add_column('fncs_actor', 'user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Actor.user'
        db.delete_column('fncs_actor', 'user_id')
