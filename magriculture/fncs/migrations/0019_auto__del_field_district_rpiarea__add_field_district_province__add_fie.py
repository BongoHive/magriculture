...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'District.rpiarea'
        db.delete_column('fncs_district', 'rpiarea_id')

        # Adding field 'District.province'
        db.add_column('fncs_district', 'province', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['fncs.Province']), keep_default=False)

        # Adding field 'District.code'
        db.add_column('fncs_district', 'code', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'District.rpiarea'
        raise RuntimeError("Cannot reverse this migration. 'District.rpiarea' and its values cannot be restored.")

        # Deleting field 'District.province'
        db.delete_column('fncs_district', 'province_id')

        # Deleting field 'District.code'
        db.delete_column('fncs_district', 'code')
