...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field districts on 'Farmer'
        db.create_table('fncs_farmer_districts', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('farmer', models.ForeignKey(orm['fncs.farmer'], null=False)),
            ('district', models.ForeignKey(orm['fncs.district'], null=False))
        ))
        db.create_unique('fncs_farmer_districts', ['farmer_id', 'district_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field districts on 'Farmer'
        db.delete_table('fncs_farmer_districts')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 12, 13, 25, 28, 234571)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 11, 12, 13, 25, 28, 234379)'}),
