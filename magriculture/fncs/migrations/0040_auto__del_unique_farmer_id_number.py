...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Farmer', fields ['id_number']
        db.delete_unique('fncs_farmer', ['id_number'])


    def backwards(self, orm):
        
        # Adding unique constraint on 'Farmer', fields ['id_number']
        db.create_unique('fncs_farmer', ['id_number'])
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 6, 11, 23, 48, 871728)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 6, 11, 23, 48, 871603)'}),
