...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'CropReceipt'
        db.create_table('fncs_cropreceipt', (
            ...
            ('quality', self.gf('django.db.models.fields.IntegerField')(default=5)),
            ('amount', self.gf('django.db.models.fields.FloatField')()),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')()),
            ('reconciled', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('fncs', ['CropReceipt'])

        # Deleting field 'Transaction.crop'
        db.delete_column('fncs_transaction', 'crop_id')

        # Deleting field 'Transaction.agent'
        db.delete_column('fncs_transaction', 'agent_id')

        # Deleting field 'Transaction.quality'
        db.delete_column('fncs_transaction', 'quality')

        # Deleting field 'Transaction.market'
        db.delete_column('fncs_transaction', 'market_id')

        # Deleting field 'Transaction.unit'
        db.delete_column('fncs_transaction', 'unit_id')

        # Deleting field 'Transaction.farmer'
        db.delete_column('fncs_transaction', 'farmer_id')

        # Adding field 'Transaction.crop_receipt'
        db.add_column('fncs_transaction', 'crop_receipt', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['fncs.CropReceipt']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'CropReceipt'
        db.delete_table('fncs_cropreceipt')

        # User chose to not deal with backwards NULL issues for 'Transaction.crop'
        raise RuntimeError("Cannot reverse this migration. 'Transaction.crop' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Transaction.agent'
        raise RuntimeError("Cannot reverse this migration. 'Transaction.agent' and its values cannot be restored.")

        # Adding field 'Transaction.quality'
        db.add_column('fncs_transaction', 'quality', self.gf('django.db.models.fields.IntegerField')(default=5), keep_default=False)

        # User chose to not deal with backwards NULL issues for 'Transaction.market'
        raise RuntimeError("Cannot reverse this migration. 'Transaction.market' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Transaction.unit'
        raise RuntimeError("Cannot reverse this migration. 'Transaction.unit' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Transaction.farmer'
        raise RuntimeError("Cannot reverse this migration. 'Transaction.farmer' and its values cannot be restored.")

        # Deleting field 'Transaction.crop_receipt'
        db.delete_column('fncs_transaction', 'crop_receipt_id')
