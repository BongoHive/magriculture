...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Farmer.farmergroup'
        db.delete_column('fncs_farmer', 'farmergroup_id')


    def backwards(self, orm):
        
        # Adding field 'Farmer.farmergroup'
        db.add_column('fncs_farmer', 'farmergroup', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fncs.FarmerGroup'], null=True), keep_default=False)
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 3, 13, 44, 11, 851545)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 3, 13, 44, 11, 851412)'}),
        ...
        'fncs.farmer': {
            ...
            'districts': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['fncs.District']", 'symmetrical': 'False'}),
