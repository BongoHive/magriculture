...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FarmerGroup.actor'
        db.add_column('fncs_farmergroup', 'actor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fncs.Actor'], null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'FarmerGroup.actor'
        db.delete_column('fncs_farmergroup', 'actor_id')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 13, 11, 15, 46, 329118)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 13, 11, 15, 46, 328954)'}),
        ...
        'fncs.farmergroup': {
            ...
            'actor': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['fncs.Actor']", 'null': 'True'}),
