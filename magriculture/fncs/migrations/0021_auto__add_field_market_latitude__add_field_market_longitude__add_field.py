...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Market.latitude'
        db.add_column('fncs_market', 'latitude', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'Market.longitude'
        db.add_column('fncs_market', 'longitude', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'Market.altitude'
        db.add_column('fncs_market', 'altitude', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'Market.volume'
        db.add_column('fncs_market', 'volume', self.gf('django.db.models.fields.CharField')(default='unknown', max_length=100, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Market.latitude'
        db.delete_column('fncs_market', 'latitude')

        # Deleting field 'Market.longitude'
        db.delete_column('fncs_market', 'longitude')

        # Deleting field 'Market.altitude'
        db.delete_column('fncs_market', 'altitude')

        # Deleting field 'Market.volume'
        db.delete_column('fncs_market', 'volume')
