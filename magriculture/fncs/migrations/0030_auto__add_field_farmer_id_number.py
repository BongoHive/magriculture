...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Farmer.id_number'
        db.add_column('fncs_farmer', 'id_number', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Farmer.id_number'
        db.delete_column('fncs_farmer', 'id_number')
