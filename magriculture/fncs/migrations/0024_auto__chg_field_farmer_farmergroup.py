...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Farmer.farmergroup'
        db.alter_column('fncs_farmer', 'farmergroup_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fncs.FarmerGroup'], null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Farmer.farmergroup'
        raise RuntimeError("Cannot reverse this migration. 'Farmer.farmergroup' and its values cannot be restored.")
    ...
    models = {
        ...
        'fncs.farmer': {
            ...
            'farmergroup': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['fncs.FarmerGroup']", 'null': 'True'}),
