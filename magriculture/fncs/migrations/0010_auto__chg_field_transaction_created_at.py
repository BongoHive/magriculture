...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Transaction.created_at'
        db.alter_column('fncs_transaction', 'created_at', self.gf('django.db.models.fields.DateTimeField')())


    def backwards(self, orm):
        
        # Changing field 'Transaction.created_at'
        db.alter_column('fncs_transaction', 'created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
