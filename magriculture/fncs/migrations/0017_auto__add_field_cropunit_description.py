...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CropUnit.description'
        db.add_column('fncs_cropunit', 'description', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CropUnit.description'
        db.delete_column('fncs_cropunit', 'description')
