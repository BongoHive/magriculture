...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('fncs_offer', 'price')

        # Deleting field 'Offer.agent'
        db.delete_column('fncs_offer', 'agent_id')

        # Adding field 'Offer.price_floor'
        db.add_column('fncs_offer', 'price_floor', self.gf('django.db.models.fields.FloatField')(default=1), keep_default=False)

        # Adding field 'Offer.price_ceiling'
        db.add_column('fncs_offer', 'price_ceiling', self.gf('django.db.models.fields.FloatField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'Offer.price'
        raise RuntimeError("Cannot reverse this migration. 'Offer.price' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Offer.agent'
        raise RuntimeError("Cannot reverse this migration. 'Offer.agent' and its values cannot be restored.")

        # Deleting field 'Offer.price_floor'
        db.delete_column('fncs_offer', 'price_floor')

        # Deleting field 'Offer.price_ceiling'
        db.delete_column('fncs_offer', 'price_ceiling')
