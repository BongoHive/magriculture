...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field wards on 'Farmer'
        db.create_table('fncs_farmer_wards', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('farmer', models.ForeignKey(orm['fncs.farmer'], null=False)),
            ('ward', models.ForeignKey(orm['fncs.ward'], null=False))
        ))
        db.create_unique('fncs_farmer_wards', ['farmer_id', 'ward_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field wards on 'Farmer'
        db.delete_table('fncs_farmer_wards')
