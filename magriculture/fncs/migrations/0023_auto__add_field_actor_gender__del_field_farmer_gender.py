...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Actor.gender'
        db.add_column('fncs_actor', 'gender', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Actor.gender'
        db.delete_column('fncs_actor', 'gender')
