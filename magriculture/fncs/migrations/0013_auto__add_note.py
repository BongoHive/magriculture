...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Note'
        db.create_table('fncs_note', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('owner', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fncs.Actor'])),
            ('about_actor', self.gf('django.db.models.fields.related.ForeignKey')(related_name='attachednote_set', to=orm['fncs.Actor'])),
            ('content', self.gf('django.db.models.fields.TextField')()),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('fncs', ['Note'])


    def backwards(self, orm):
        
        # Deleting model 'Note'
        db.delete_table('fncs_note')
