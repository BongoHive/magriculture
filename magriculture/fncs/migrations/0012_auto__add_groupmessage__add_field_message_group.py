...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('fncs_groupmessage', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sender', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fncs.Actor'])),
            ('content', self.gf('django.db.models.fields.CharField')(max_length=120)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('fncs', ['GroupMessage'])

        # Adding M2M table for field farmergroups on 'GroupMessage'
        db.create_table('fncs_groupmessage_farmergroups', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('groupmessage', models.ForeignKey(orm['fncs.groupmessage'], null=False)),
            ('farmergroup', models.ForeignKey(orm['fncs.farmergroup'], null=False))
        ))
        db.create_unique('fncs_groupmessage_farmergroups', ['groupmessage_id', 'farmergroup_id'])

        # Adding field 'Message.group'
        db.add_column('fncs_message', 'group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fncs.GroupMessage'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'GroupMessage'
        db.delete_table('fncs_groupmessage')

        # Removing M2M table for field farmergroups on 'GroupMessage'
        db.delete_table('fncs_groupmessage_farmergroups')

        # Deleting field 'Message.group'
        db.delete_column('fncs_message', 'group_id')
