...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field wards on 'FarmerGroup'
        db.create_table('fncs_farmergroup_wards', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('farmergroup', models.ForeignKey(orm['fncs.farmergroup'], null=False)),
            ('ward', models.ForeignKey(orm['fncs.ward'], null=False))
        ))
        db.create_unique('fncs_farmergroup_wards', ['farmergroup_id', 'ward_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field wards on 'FarmerGroup'
        db.delete_table('fncs_farmergroup_wards')
