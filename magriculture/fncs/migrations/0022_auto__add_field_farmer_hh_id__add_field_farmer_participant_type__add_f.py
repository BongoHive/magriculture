...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Farmer.hh_id'
        db.add_column('fncs_farmer', 'hh_id', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)

        # Adding field 'Farmer.participant_type'
        db.add_column('fncs_farmer', 'participant_type', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)

        # Adding field 'Farmer.gender'
        db.add_column('fncs_farmer', 'gender', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)

        # Adding field 'Farmer.number_of_males'
        db.add_column('fncs_farmer', 'number_of_males', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Farmer.number_of_females'
        db.add_column('fncs_farmer', 'number_of_females', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Farmer.hh_id'
        db.delete_column('fncs_farmer', 'hh_id')

        # Deleting field 'Farmer.participant_type'
        db.delete_column('fncs_farmer', 'participant_type')

        # Deleting field 'Farmer.gender'
        db.delete_column('fncs_farmer', 'gender')

        # Deleting field 'Farmer.number_of_males'
        db.delete_column('fncs_farmer', 'number_of_males')

        # Deleting field 'Farmer.number_of_females'
        db.delete_column('fncs_farmer', 'number_of_females')
