...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('fncs_message', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sender', self.gf('django.db.models.fields.related.ForeignKey')(related_name='sender_set', to=orm['fncs.Actor'])),
            ('recipient', self.gf('django.db.models.fields.related.ForeignKey')(related_name='recipient_set', to=orm['fncs.Actor'])),
            ('content', self.gf('django.db.models.fields.CharField')(max_length=120)),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('fncs', ['Message'])


    def backwards(self, orm):
        
        # Deleting model 'Message'
        db.delete_table('fncs_message')
    ...
    models = {
        ...
        'fncs.message': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'recipient': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'recipient_set'", 'to': "orm['fncs.Actor']"}),
            'sender': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'sender_set'", 'to': "orm['fncs.Actor']"})
        },
        'fncs.offer': {
