...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field markets on 'Farmer'
        db.create_table('fncs_farmer_markets', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('farmer', models.ForeignKey(orm['fncs.farmer'], null=False)),
            ('market', models.ForeignKey(orm['fncs.market'], null=False))
        ))
        db.create_unique('fncs_farmer_markets', ['farmer_id', 'market_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field markets on 'Farmer'
        db.delete_table('fncs_farmer_markets')
