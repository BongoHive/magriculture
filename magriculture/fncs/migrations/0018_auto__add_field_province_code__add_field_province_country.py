...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Province.code'
        db.add_column('fncs_province', 'code', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Province.country'
        db.add_column('fncs_province', 'country', self.gf('django.db.models.fields.CharField')(default='--', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Province.code'
        db.delete_column('fncs_province', 'code')

        # Deleting field 'Province.country'
        db.delete_column('fncs_province', 'country')
