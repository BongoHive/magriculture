...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FarmerGroup.zone'
        db.alter_column('fncs_farmergroup', 'zone_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fncs.Zone'], null=True))

        # Changing field 'FarmerGroup.district'
        db.alter_column('fncs_farmergroup', 'district_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fncs.District'], null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'FarmerGroup.zone'
        raise RuntimeError("Cannot reverse this migration. 'FarmerGroup.zone' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'FarmerGroup.district'
        raise RuntimeError("Cannot reverse this migration. 'FarmerGroup.district' and its values cannot be restored.")
